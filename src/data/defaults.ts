...
export const colorOptions = [
  ...
  { name: 'Lime', hex: '#84cc16', soft: '#ecfccb' },
  { name: 'Xanh lá', hex: '#16a34a', soft: '#dcfce7' },
  { name: 'Ngọc', hex: '#0f766e', soft: '#d1fae5' },
  { name: 'Xanh dương', hex: '#2563eb', soft: '#dbeafe' },
  { name: 'Xanh trời', hex: '#0284c7', soft: '#e0f2fe' },
  { name: 'Tím', hex: '#7c3aed', soft: '#e9d5ff' },
  { name: 'Fuchsia', hex: '#c026d3', soft: '#fae8ff' },
  { name: 'Indigo', hex: '#4f46e5', soft: '#e0e7ff' },
  { name: 'Xám', hex: '#64748b', soft: '#f1f5f9' },
  { name: 'Than', hex: '#111827', soft: '#e5e7eb' },
  { name: 'Nâu', hex: '#a16207', soft: '#fef3c7' },
  { name: 'Xanh ngọc', hex: '#06b6d4', soft: '#cffafe' },
] as const
